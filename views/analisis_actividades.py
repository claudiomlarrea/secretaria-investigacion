...
render_header(
    ...
    "(Docencia, Investigación y Extensión). Matrícula y plantel: memorias académicas/económicas."
)
...
st.caption(
    ...
    "Alumnos y docentes: memorias institucionales por año "
    "(2025: Memoria Académica; 2023–2024: Memoria Económica con desglose por sede estimado)."
)
